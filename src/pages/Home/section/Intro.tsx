...
const Intro = ({ elRefMain, elRefLeft, elRefRight, elRefOmoty }: Props) => {
  return (
    <div className={styles.intro} id='intro' ref={elRefMain}>
      <div className={styles.introContainer}>
        <div className='pc-only'></div>

        <div className={styles.introLeft} ref={elRefLeft}>
          <div className={styles.omoty} ref={elRefOmoty}>
            <svg
        ...
        <div className={styles.introRight} ref={elRefRight}>
