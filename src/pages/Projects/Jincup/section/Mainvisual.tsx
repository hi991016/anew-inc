import mainvisualImg from 'src/assets/Projects/Jincup/mainvisual.webp'
import mainvisualSpImg from 'src/assets/Projects/Jincup/mainvisual_sp.webp'
              ...
              <g id='logo' transform='translate(-1273.479 -653)'>
                <g id='Group_127' data-name='Group 127' transform='translate(1274.341 653)'>
                  <g
                    ...
                    clipPath='url(#clip-path-mainvisual)'
                  >
                    <path
                      id='Path_305'
                      data-name='Path 305'
