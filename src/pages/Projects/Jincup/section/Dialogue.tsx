...
/* ---------------------------------- image --------------------------------- */
import dialogueImg from 'src/assets/Projects/Jincup/dialogue.webp'
import dialogueSpImg from 'src/assets/Projects/Jincup/dialogue_sp.webp'

import dialoguePhoto1 from 'src/assets/Projects/Jincup/dialogue_body_01.webp'
import dialoguePhoto2 from 'src/assets/Projects/Jincup/dialogue_body_02.webp'
import dialoguePhoto3 from 'src/assets/Projects/Jincup/dialogue_body_03.webp'

import dialogueSlide1 from 'src/assets/Projects/Jincup/dialogue_body_slide_01.webp'
import dialogueSlide2 from 'src/assets/Projects/Jincup/dialogue_body_slide_02.webp'
import dialogueSlide3 from 'src/assets/Projects/Jincup/dialogue_body_slide_03.webp'
import dialogueSlide4 from 'src/assets/Projects/Jincup/dialogue_body_slide_04.webp'
import dialogueSlide5 from 'src/assets/Projects/Jincup/dialogue_body_slide_05.webp'
import dialogueSlide6 from 'src/assets/Projects/Jincup/dialogue_body_slide_06.webp'
import dialogueSlide7 from 'src/assets/Projects/Jincup/dialogue_body_slide_07.webp'
import dialogueSlide8 from 'src/assets/Projects/Jincup/dialogue_body_slide_08.webp'
import dialogueSlide9 from 'src/assets/Projects/Jincup/dialogue_body_slide_09.webp'
import dialogueSlide10 from 'src/assets/Projects/Jincup/dialogue_body_slide_10.webp'
...
const Dialogue = ({ lang, elRef }: { lang?: string; elRef?: any }) => {
  ...
  return (
    <section className={styles.dialogue} ref={elRef} id='dialogue' data-jincup-section>
                ...
                <SwitchTransition mode='out-in' key={i}>
                  ...
                  >
                    <div className={styles.items} key={i}>
                      <h3 className={lang === 'jp' ? '' : `${styles.en} sansserif-fonts`}>
                        {lang === 'jp' ? items.titleJp : items.titleEn}
                      </h3>
                      <p className={lang === 'jp' ? '' : `${styles.en} sansserif-fonts`}>
                        {lang === 'jp' ? items.descJp : items.descEn}
                      </p>
                    </div>
                  </CSSTransition>
                </SwitchTransition>
